  ...
  [643],
  {
          ...
          return (
            ...
            (0, r.jsxs)(o.default, {
              children: [
                ...
                (0, r.jsx)('link', { rel: 'apple-touch-icon', href: i.Z.appleTouchIconPath }),
                (0, r.jsx)('link', { rel: 'manifest', href: '/manifest.json' }),
                (0, r.jsx)('meta', { name: 'theme-color', content: i.Z.themeColor }, 'theme-color'),
                (0, r.jsx)('meta', { property: 'og:type', content: 'website' }, 'og:type'),
                (0, r.jsx)('meta', { property: 'og:site_name', content: i.Z.title }, 'og:site_name'),
                (0, r.jsx)('meta', { name: 'author', content: i.Z.author }, 'author'),
                (null === a || void 0 === a ? void 0 : a.length) && (0, r.jsx)('meta', { name: 'keyword', content: a.join(', ') }, 'keyword'),
                ...
                (0, r.jsx)('meta', { property: 'og:image', content: l }, 'og:image'),
                u && u,
    ...
    9337: function (e, t, n) {
      ...
      var g = function (e) {
        ...
        ;(0, l.useEffect)(
          function () {
            for (var e = [], r = [], o = Math.floor(u / 2), i = 0; i < o; i++) {
              var a = t - o + i
              a > 0 && e.push(a)
              var c = t + 1 + i
              c <= n && r.push(c)
        ...
        var y = function (e) {
          ...
          return d && (t += '?query='.concat(d)), t
        }
        return (0, r.jsx)('div', {
          className: f().container,
          children: (0, r.jsxs)('ul', {
            children: [
              t > 1 && (0, r.jsx)('li', { children: (0, r.jsx)(s.default, { href: y(t - 1), children: (0, r.jsx)('a', { children: (0, r.jsx)(i, {}) }) }) }),
              t > 1 &&
                !m.includes(1) &&
                (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)('li', { children: (0, r.jsx)('a', { href: y(1), children: 1 }) }), (0, r.jsx)(a, {})] }),
              m.map(function (e) {
                return (0, r.jsx)('li', { children: (0, r.jsx)('a', { className: t === e ? f().currentPage : '', href: y(e), children: e }) }, e)
              }),
              t < n &&
                !m.includes(n) &&
                (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(a, {}), (0, r.jsx)('li', { children: (0, r.jsx)('a', { href: y(n), children: n }) })] }),
              t < n && (0, r.jsx)('li', { children: (0, r.jsx)('a', { href: y(t + 1), children: (0, r.jsx)(c, {}) }) }),
            ],
          }),
        })
      }
    ...
    7221: function (e, t, n) {
      ...
      t.Z = function (e) {
        var t = e.titleLevel,
          n = void 0 === t ? 3 : t,
          l = e.post,
          f = (0, i.Z)(new Date(l.publishedAt))
        return (0, r.jsxs)('article', {
          ...
          children: [
            ...
            (0, r.jsx)('span', { className: u().publishedAt, children: f }),
            (0, r.jsx)(o.default, {
              href: c.Z.buildLinkURLByTitle(l.title),
            ...
            l.thumbnailName &&
              (0, r.jsx)('div', {
                ...
                children: (0, r.jsx)(o.default, {
                  href: c.Z.buildLinkURLByTitle(l.title),
                  children: (0, r.jsx)('a', {
                    children: (0, r.jsx)('img', { className: 'thumbnail', src: a.Z.buildImagePath(l.thumbnailName), alt: l.description }),
                  }),
                }),
              }),
            (0, r.jsx)('section', { className: u().tags, children: (0, r.jsx)(s.Z, { tags: l.tags }) }),
          ],
        })
      }
    },
      ...
      var r = n(5893),
        ...
        s = function (e) {
          return (0, r.jsx)(o.default, {
            href: ''.concat(i.Z.baseURL, '/posts/1?query=').concat(encodeURI(e.tag)),
            children: (0, r.jsx)('a', { children: (0, r.jsxs)('span', { className: c().tag, children: [e.tag, ' ', e.count && e.count] }) }),
          })
        },
        l = n(8193),
        u = n.n(l),
    ...
    8899: function (e, t, n) {
      ...
      t.default = function (e) {
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            (0, r.jsx)(o.Z, {
              title: l.Z.buildPageTitle(d),
              description: ''.concat(d, ' ').concat(t, ' \ud398\uc774\uc9c0'),
              url: ''.concat(s.Z.baseURL, '/categories/').concat(d, '/').concat(t, '}'),
              imageURL: '/icons/icon-512x512.png',
              keywords: u
                .map(function (e) {
                  return f(e.tags).concat([e.title, e.category, e.description])
                })
                .flat(),
            }),
            (0, r.jsx)('h1', { children: d }),
            Boolean(null === u || void 0 === u ? void 0 : u.length) &&
              u.map(function (e, t) {
                return (0, r.jsx)(c.Z, { titleLevel: 2, post: e }, t)
              }),
            (0, r.jsx)(i.Z, { adClient: s.Z.googleAdsense.adClient, adSlot: '5391522351' }),
            (0, r.jsx)(a.Z, { page: t, lastPage: n, baseURL: ''.concat(s.Z.baseURL, '/categories/').concat(d) }),
          ],
        })
      }
    },
        ...
        return (
          ...
          (r = [
            ...
            },
            {
              ...
              value: function (e) {
                return ''.concat(i.Z.baseURL, '/').concat(this.normalizeTitle(e))
              },
            },
          ]),
      ...
      !(function () {
        ...
        var t = {
            977: function (e) {
              ...
              function n(e, t) {
                for (var n, r = '', o = 0, i = -1, a = 0, c = 0; c <= e.length; ++c) {
                  ...
                  if (47 === n) {
                    if (i === c - 1 || 1 === a);
                      ...
                      if (r.length < 2 || 2 !== o || 46 !== r.charCodeAt(r.length - 1) || 46 !== r.charCodeAt(r.length - 2))
                        if (r.length > 2) {
                          var s = r.lastIndexOf('/')
                          if (s !== r.length - 1) {
                            ;-1 === s ? ((r = ''), (o = 0)) : (o = (r = r.slice(0, s)).length - 1 - r.lastIndexOf('/')), (i = c), (a = 0)
                            continue
                          }
                    ...
                    } else r.length > 0 ? (r += '/' + e.slice(i + 1, c)) : (r = e.slice(i + 1, c)), (o = c - i - 1)
                    ;(i = c), (a = 0)
                  } else 46 === n && -1 !== a ? ++a : (a = -1)
                }
                return r
              ...
              var o = {
                ...
                relative: function (e, n) {
                  ...
                  for (var i = e.length, a = i - r, c = 1; c < n.length && 47 === n.charCodeAt(c); ++c);
                  for (var s = n.length - c, l = a < s ? a : s, u = -1, f = 0; f <= l; ++f) {
                    if (f === l) {
                      if (s > l) {
                        if (47 === n.charCodeAt(c + f)) return n.slice(c + f + 1)
                        if (0 === f) return n.slice(c + f)
                      } else a > l && (47 === e.charCodeAt(r + f) ? (u = f) : 0 === f && (u = 0))
                      break
                    }
                    var d = e.charCodeAt(r + f)
                    if (d !== n.charCodeAt(c + f)) break
                    47 === d && (u = f)
                  }
                  var h = ''
                  for (f = r + u + 1; f <= i; ++f) (f !== i && 47 !== e.charCodeAt(f)) || (0 === h.length ? (h += '..') : (h += '/..'))
                  return h.length > 0 ? h + n.slice(c + u) : ((c += u), 47 === n.charCodeAt(c) && ++c, n.slice(c))
                },
                ...
                basename: function (e, n) {
                  ...
                  if (void 0 !== n && n.length > 0 && n.length <= e.length) {
                    ...
                    for (r = e.length - 1; r >= 0; --r) {
                      ...
                      } else -1 === s && ((a = !1), (s = r + 1)), c >= 0 && (l === n.charCodeAt(c) ? -1 === --c && (i = r) : ((c = -1), (i = s)))
                    }
                    return o === i ? (i = s) : -1 === i && (i = e.length), e.slice(o, i)
                  }
                  for (r = e.length - 1; r >= 0; --r)
                ...
                extname: function (e) {
                  t(e)
                  for (var n = -1, r = 0, o = -1, i = !0, a = 0, c = e.length - 1; c >= 0; --c) {
                    var s = e.charCodeAt(c)
                    if (47 !== s) -1 === o && ((i = !1), (o = c + 1)), 46 === s ? (-1 === n ? (n = c) : 1 !== a && (a = 1)) : -1 !== n && (a = -1)
                    else if (!i) {
                      r = c + 1
                      break
                    }
                ...
                parse: function (e) {
                  ...
                  var r,
                    ...
                    i = 47 === o
                  i ? ((n.root = '/'), (r = 1)) : (r = 0)
                  for (var a = -1, c = 0, s = -1, l = !0, u = e.length - 1, f = 0; u >= r; --u)
                    if (47 !== (o = e.charCodeAt(u)))
                      -1 === s && ((l = !1), (s = u + 1)), 46 === o ? (-1 === a ? (a = u) : 1 !== f && (f = 1)) : -1 !== a && (f = -1)
                    else if (!l) {
                      c = u + 1
                      break
                    }
                  return (
                    -1 === a || -1 === s || 0 === f || (1 === f && a === s - 1 && a === c + 1)
                      ? -1 !== s && (n.base = n.name = 0 === c && i ? e.slice(1, s) : e.slice(c, s))
                      : (0 === c && i ? ((n.name = e.slice(1, a)), (n.base = e.slice(1, s))) : ((n.name = e.slice(c, a)), (n.base = e.slice(c, s))),
                        (n.ext = e.slice(a, s))),
                    c > 0 ? (n.dir = e.slice(0, c - 1)) : i && (n.dir = '/'),
                    n
                  )
                },
                sep: '/',
        ...
        var t = {
            162: function (e) {
              ...
              var c,
                ...
                u = -1
              function f() {
                l && c && ((l = !1), c.length ? (s = c.concat(s)) : (u = -1), s.length && d())
              }
              function d() {
                if (!l) {
                  var e = a(f)
