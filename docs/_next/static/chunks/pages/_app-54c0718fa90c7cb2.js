;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [888],
  {
    7026: function (e, t, r) {
      ...
      ;(N.propTypes = {}), (N.filterProps = I), (W.propTypes = {}), (W.filterProps = R), (D.propTypes = {}), (D.filterProps = T)
      var H = D
      ...
      function be(e, t) {
        ...
        return h(
          n({ htmlFontSize: f, pxToRem: y, fontFamily: o, fontSize: a, fontWeightLight: s, fontWeightRegular: c, fontWeightMedium: l, fontWeightBold: u }, v),
          m,
          { clone: !1 }
        )
      }
      ...
      function Pe(e = {}, ...t) {
        const { mixins: r = {}, palette: o = {}, transitions: a = {}, typography: s = {} } = e,
          ...
          l = he(o),
          u = G(e)
        let f = h(u, { mixins: Z(u.breakpoints, u.spacing, r), palette: l, shadows: xe.slice(), typography: be(l, s), transitions: je(a), zIndex: n({}, Ce) })
          ...
          case 4765:
            if (Ge(e) - 1 - t > 6)
              switch (He(e, t + 1)) {
                ...
                case 115:
                  return ~De(e, 'stretch') ? St(We(e, 'stretch', 'fill-available'), t) + e : e
              }
            break
          case 4949:
            if (115 !== He(e, t + 1)) break
          case 6444:
            switch (He(e, Ge(e) - 3 - (~De(e, '!important') && 10))) {
              case 107:
                return We(e, ':', ':' + yt) + e
              case 101:
      ...
      function jt(e, t, r, n, o, a, i, s, c) {
        for (var l = 0, u = 0, f = i, p = 0, d = 0, h = 0, m = 1, g = 1, y = 1, b = 0, v = '', x = o, k = a, w = n, A = v; g; )
          switch (((h = b), (b = rt()))) {
            case 40:
              if (108 != h && 58 == A.charCodeAt(f - 1)) {
                ;-1 != De((A += We(lt(b), '&', '&\f')), '&\f') && (y = -1)
                break
              }
            case 34:
            case 39:
            ...
            case 0:
              switch (b) {
                ...
                case 59:
                  A += ';'
                default:
                  if ((Ue((w = Ct(A, t, r, l, u, o, s, v, (x = []), (k = []), f)), a), 123 === b))
                    if (0 === u) jt(A, t, w, w, x, a, f, s, k)
                    else
                      switch (p) {
                        case 100:
                        case 109:
                        case 115:
                          jt(e, w, w, n && Ue(Ct(e, w, w, 0, 0, o, s, v, o, (x = []), f), k), o, k, f, s, n ? x : k)
                          break
                        default:
                          jt(A, w, w, w, [''], k, 0, s, k)
                      }
      ...
      function Ct(e, t, r, n, o, a, i, s, c, l, u) {
        for (var f = o - 1, p = 0 === o ? a : [''], d = Ke(p), h = 0, m = 0, g = 0; h < n; ++h)
          for (var y = 0, b = Fe(e, f + 1, (f = ze((m = i[h])))), v = e; y < d; ++y) (v = Ne(m > 0 ? p[y] + ' ' + b : We(b, /&\f/g, p[y]))) && (c[g++] = v)
        return Qe(e, t, r, 0 === o ? vt : s, c, l, u)
      }
      function _t(e, t, r) {
        return Qe(e, t, r, bt, Le(Ye), Fe(e, 2, -2), 0)
      }
      function Pt(e, t, r, n) {
        return Qe(e, t, r, xt, Fe(e, 0, n), Fe(e, n + 1, -1), n)
      }
        ...
        Tt = function (e) {
          if ('rule' === e.type && e.parent && !(e.length < 1)) {
            ...
            if ((1 !== e.props.length || 58 === t.charCodeAt(0) || Rt.get(r)) && !n) {
              Rt.set(e, !0)
              for (var o = [], a = It(t, o), i = r.props, s = 0, c = 0; s < a.length; s++)
      ...
      var Lt = function (e) {
        ...
        Ft = Re(function (e) {
          return Dt(e) ? e : e.replace(Nt, '-$&').toLowerCase()
        }),
        Gt = function (e, t) {
          switch (e) {
            case 'animation':
          ...
          return 1 === Bt[e] || Dt(e) || 'number' !== typeof t || 0 === t ? t : t + 'px'
        }
      function Kt(e, t, r) {
        if (null == r) return ''
          ...
          case 'object':
            ...
            return (function (e, t, r) {
              ...
              if (Array.isArray(r)) for (var o = 0; o < r.length; o++) n += Kt(e, t, r[o]) + ';'
                ...
                for (var a in r) {
                  var i = r[a]
                  if ('object' !== typeof i) null != t && void 0 !== t[i] ? (n += a + '{' + t[i] + '}') : Ht(i) && (n += Ft(a) + ':' + Gt(a, i) + ';')
                  ...
                  } else for (var c = 0; c < i.length; c++) Ht(i[c]) && (n += Ft(a) + ':' + Gt(a, i[c]) + ';')
                }
              return n
            })(e, t, r)
          case 'function':
          ...
          return function () {
            ...
            var g = Xt(function (e, t, r) {
              ...
              var g = f && void 0 === l ? rr(n) : u,
                y = {}
              for (var b in e) (f && 'as' === b) || (g(b) && (y[b] = e[b]))
              return (
                (y.className = a),
                (y.ref = r),
                (0, o.createElement)(
      ...
      var Or = pr(hr, mr, gr, yr, br, vr, xr, kr, wr, Ar, Sr)
      var jr = pr(
      ...
      var Mr = O({ prop: 'boxShadow', themeKey: 'shadows' })
      function Er(e) {
        return e <= 1 && 0 !== e ? 100 * e + '%' : e
      }
      const zr = O({ prop: 'width', transform: Er }),
        Lr = (e) => {
          if (void 0 !== e.maxWidth && null !== e.maxWidth) {
            const t = (t) => {
              var r, n, o
              return { maxWidth: (null == (r = e.theme) || null == (n = r.breakpoints) || null == (o = n.values) ? void 0 : o[t]) || b[t] || Er(t) }
            }
      ...
      const Br = O({ prop: 'minWidth', transform: Er }),
        ...
        Dr = O({ prop: 'minHeight', transform: Er })
      O({ prop: 'size', cssProperty: 'width', transform: Er }), O({ prop: 'size', cssProperty: 'height', transform: Er })
      var Hr = pr(zr, Lr, Br, Nr, Wr, Dr, O({ prop: 'boxSizing' }))
      const Fr = O({ prop: 'fontFamily', themeKey: 'typography' }),
        ...
        Zr = O({ prop: 'lineHeight' }),
        Xr = O({ prop: 'textAlign' })
      var Yr = pr(O({ prop: 'typography', cssProperty: !1, themeKey: 'typography' }), Fr, Gr, Kr, Ur, Vr, Zr, Xr, qr)
      const Jr = {
        ...
        Qr = { borders: Or, display: jr, flexbox: Cr, grid: Ir, positions: Rr, palette: Tr, shadows: Mr, sizing: Hr, spacing: H, typography: Yr }
      ...
      const yn = ['children', 'className', 'color', 'component', 'fontSize', 'htmlColor', 'inheritViewBox', 'titleAccess', 'viewBox'],
        ...
        vn = un('svg', {
          ...
          var r, n, o, a, i, s, c, l, u, f, p, d, h, m, g, y, b
          return {
            userSelect: 'none',
            width: '1em',
            height: '1em',
        ...
        xn = o.forwardRef(function (e, t) {
          const r = Ie({ props: e, name: 'MuiSvgIcon' }),
            {
              children: o,
              className: a,
              color: s = 'inherit',
          ...
          const b = bn(g)
          return (0,
          gn.jsxs)(vn, n({ as: l, className: c(b.root, a), ownerState: g, focusable: 'false', color: f, 'aria-hidden': !d || void 0, role: d ? 'img' : void 0, ref: t }, y, m, { children: [o, d ? (0, gn.jsx)('title', { children: d }) : null] }))
        })
      xn.muiName = 'SvgIcon'
      var kn = xn
      function wn(e, t) {
    ...
    3589: function (e, t, r) {
      ...
      t.Z = function (e) {
        var t, r
        return (
          'main' === e.position ? ((t = 320), (r = 100)) : ((t = 160), (r = 600)),
          (0, n.jsx)('ins', { className: 'kakao_ad_area', style: { display: 'none' }, 'data-ad-unit': e.adfitUnitID, 'data-ad-width': t, 'data-ad-height': r })
        )
      }
    },
    8145: function (e, t) {
      ...
      t.Z = {
        ...
        googleAdsense: { adClient: 'ca-pub-7134579063537339' },
      }
    },
    8418: function (e, t, r) {
      'use strict'
      ...
      var p = function (e) {
        ...
        var v = (t = i.default.Children.only(h)) && 'object' === typeof t && t.ref,
          x = o(l.useIntersection({ rootMargin: '200px' }), 2),
          k = x[0],
          w = x[1],
          A = i.default.useCallback(
            function (e) {
              k(e), v && ('function' === typeof v ? v(e) : 'object' === typeof v && (v.current = e))
            },
            [v, k]
          )
        i.default.useEffect(
        ...
        if (e.passHref || ('a' === t.type && !('href' in t.props))) {
          var O = 'undefined' !== typeof b ? b : n && n.locale,
            j = n && n.isLocaleDomain && s.getDomainLocale(d, O, n && n.locales, n && n.domainLocales)
          S.href = j || s.addBasePath(s.addLocale(d, O, n && n.defaultLocale))
        }
      ...
      var n = r(5893),
        ...
        c = function (e) {
          return (0, n.jsxs)(n.Fragment, {
            children: [
              (0, n.jsx)(s.default, { src: 'https://www.googletagmanager.com/gtag/js?id='.concat(e.gaID), strategy: 'lazyOnload' }),
              (0, n.jsx)(s.default, {
                id: 'gtag-script',
                children:
        ...
        d = function (e) {
          return (0, n.jsx)(u.default, {
            href: e.href,
            children: (0, n.jsx)('a', { className: e.matched ? ''.concat(p().matched, ' ').concat(p().anchor) : p().anchor, children: e.display }),
          })
        },
        h = r(3702),
        m = r.n(h),
        ...
        x = r(3589),
        k = function () {
          return (0, n.jsx)(s.default, { async: !0, src: '//t1.daumcdn.net/kas/static/ba.min.js' })
        },
        w = function (e) {
      ...
      var $ = function (e) {
        ...
        return (0, n.jsxs)(n.Fragment, {
          children: [
            ...
            (0, n.jsx)(k, {}),
            (0, n.jsx)(w, {}),
            (0, n.jsx)(v, { title: A.Z.title, socialIcons: C, menus: O }),
            (0, n.jsx)('main', { children: (0, n.jsx)(t, P({}, r)) }),
            (0, n.jsxs)('aside', {
              children: [
                (0, n.jsx)(x.Z, { adfitUnitID: A.Z.kakaoAdfitUnitIDs.asideBannerID1, position: 'aside' }),
                (0, n.jsx)(x.Z, { adfitUnitID: A.Z.kakaoAdfitUnitIDs.asideBannerID2, position: 'aside' }),
              ],
            }),
