!(function () {
    ...
    et = e(function (t) {
      ...
      ;(t.exports = function (t, e, i, a) {
        var u = !!a && !!a.unsafe,
          s = !!a && !!a.enumerable,
          c = !!a && !!a.noTargetGet
        'function' == typeof i && ('string' != typeof e || b(i, 'name') || I(i, 'name', e), (r(i).source = o.join('string' == typeof e ? e : ''))),
  ...
  var re =
    ...
    oe = function (t, e) {
      var r
      return (
        re(t) && ('function' != typeof (r = t.constructor) || (r !== Array && !re(r.prototype)) ? g(r) && null === (r = r[ne]) && (r = void 0) : (r = void 0)),
  ...
  var Se,
    ...
    Ie = Re
      ...
      : function (t) {
          return (
            (t = Lt(t)),
            b(t, je) ? t[je] : 'function' == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? Pe : null
          )
        },
    Te = Dt('iterator'),
    ke = !1
  ...
  var Le = { IteratorPrototype: Se, BUGGY_SAFARI_ITERATORS: ke },
    ...
    Xe = function (t, e, r, n, o, i, a) {
      ...
      if (
        (g &&
          ((u = Ie(g.call(new t()))),
          ze !== Object.prototype && u.next && (Ie(u) !== ze && (qe ? qe(u, ze) : 'function' != typeof u[Ke] && I(u, Ke, He)), _e(u, l, !0))),
        o == $e &&
          d &&
          d.name !== $e &&
          ((h = !0),
  ...
  var ar = '[object z]' === String(ir),
    ...
    hr = function (t) {
      ...
      else for (i = (o = h.call(u)).next, r = new s(); !(n = i.call(o)).done; p++) (a = l ? tr(o, f, [n.value, p], !0) : n.value), or(r, p, a)
      return (r.length = p), r
    },
    pr = Dt('iterator'),
    dr = !1
    ...
    Gr = {
      getConstructor: function (t, e, r, n) {
        var o = t(function (t, a) {
            _r(t, o, e), Wr(t, { type: e, index: Ht(null), first: void 0, last: void 0, size: 0 }), i || (t.size = 0), null != a && Mr(a, t[n], t, r)
          }),
          a = Kr(e),
          u = function (t, e, r) {
            var n,
            ...
            ? function (t, r) {
                ...
                for (
                  var i,
                    ...
                    s = [],
                    c = 0,
                    f = new RegExp(t.source, (t.ignoreCase ? 'i' : '') + (t.multiline ? 'm' : '') + (t.unicode ? 'u' : '') + (t.sticky ? 'y' : '') + 'g');
                  (i = Ei.call(f, n)) &&
                  !(
                    (a = f.lastIndex) > c &&
                    (s.push(n.slice(c, i.index)), i.length > 1 && i.index < n.length && Ki.apply(s, i.slice(1)), (u = i[0].length), (c = a), s.length >= o)
                  );
  ...
  var vs,
        ...
        switch (((i = o[f]), c)) {
          ...
          case uc:
            if (((t.scheme = n.scheme), i == vs))
              (t.username = n.username), (t.password = n.password), (t.host = n.host), (t.port = n.port), (t.path = n.path.slice()), (t.query = n.query)
            else if ('/' == i || ('\\' == i && Xs(t))) c = sc
            else if ('?' == i)
              (t.username = n.username), (t.password = n.password), (t.host = n.host), (t.port = n.port), (t.path = n.path.slice()), (t.query = ''), (c = Sc)
            else {
              if ('#' != i) {
    ...
    Rc = function () {
      var t = Es(this),
        ...
        c = e + ':'
      return (
        null !== o ? ((c += '//'), Ys(t) && (c += r + (n ? ':' + n : '') + '@'), (c += zs(o)), null !== i && (c += ':' + i)) : 'file' == e && (c += '//'),
  ...
  var Ef,
    ...
    Jf = function (t, e, r) {
      var o, i
      Gf ? (((o = Bf.createEvent('Event')).promise = e), (o.reason = r), o.initEvent(t, !1, !0), n.dispatchEvent(o)) : (o = { promise: e, reason: r }),
        (i = n['on' + t])
          ? i(o)
          : t === $f &&
            (function (t, e) {
        ...
        ;(this._bodyInit = t),
          ...
          this.headers.get('content-type') ||
            ('string' == typeof t
              ...
              : cl && URLSearchParams.prototype.isPrototypeOf(t) && this.headers.set('content-type', 'application/x-www-form-urlencoded;charset=UTF-8'))
      }),
      ll &&
        ((this.blob = function () {
          var t = wl(this)
