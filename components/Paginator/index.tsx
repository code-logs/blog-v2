...
export default function Paginator({ page, lastPage, displayCount = 5, query, baseURL }: PaginatorProps) {
    ...
    <div className={style.container}>
      <ul>
        ...
        {pageList.map((pageNum) => (
          <li key={pageNum}>
            <a href={buildURL(pageNum)} className={page === pageNum ? style.currentPage : ''}>
              {pageNum}
            </a>
          </li>
        ))}
